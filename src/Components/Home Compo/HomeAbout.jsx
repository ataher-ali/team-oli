    ...
    <div className="grid grid-cols-1 lg:h-screen lg:grid-cols-2">
      ...
      <div className="relative flex items-center bg-gray-100">
        ...
        <div className="p-8 sm:p-16 lg:p-24">
          ...
          <a
            href="#"
            className="mt-8 inline-block rounded border border-yellow-400 bg-yellow-400 px-12 py-3 text-sm font-medium text-black hover:bg-opacity-80  focus:outline-none focus:ring active:text-yellow-500"
          >
            Get in Touch
          </a>
        </div>
