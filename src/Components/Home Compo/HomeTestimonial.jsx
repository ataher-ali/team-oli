...
*/}
            ...
            <section className="bg-gray-50">
                <div className=" lg:mx-280 md:mx-20 mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
                    <div className="md:flex md:items-end md:justify-between">
                        <div className="max-w-xl">
                            <Link to="/Reviews" className="text-4xl font-bold  tracking-tight text-gray-900 sm:text-5xl">
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
                        <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8">
                            <div>
                                ...
                                <div className="mt-4">
                                    <p className="text-2xl font-bold text-yellow-500 sm:text-3xl">Stayin' Alive</p>
